      ...
      <table id="mytable" class="table table-bordered table-hover">
          ...
          <tbody>
              ...
              <tr>
                  ...
                  <td>
                    <?php $bagian_terkini = $row['bagian_terkini'] == "" ? "Belum ada" : $row['bagian_terkini'];?>
                  ...
                  <td>
                  <?php $jabatan_terkini = $row['jabatan_terkini'] == "" ? "Belum ada" : $row['jabatan_terkini'];?>
                    <a href="?page=karyawanjabatan&id=<?php echo $row['id'] ?>" class="btn bg-indigo btn-sm mr-1">
